  ...
  return (
    <div style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)' }}
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs" style={{ color: 'var(--muted)' }}>Recommandation</label>
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs" style={{ color: 'var(--muted)' }}>Source</label>
        <select style={{ backgroundColor: 'var(--bg)', border: '1px solid var(--border)' }}
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs" style={{ color: 'var(--muted)' }}>Commune</label>
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs" style={{ color: 'var(--muted)' }}>Prix max : {filters.prixMax.toLocaleString()}€</label>
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs" style={{ color: 'var(--muted)' }}>Score IA min : {filters.scoreMin}/10</label>
